    ...
    public partial class Form1 : Form
    {
        ...
        private void btnBuscarCal_Click(object sender, EventArgs e)
        {
            try
            {
                int numero = int.Parse(txtNumeroCal.Text);
                string materia = txtMateria.Text;
                miLista.ModificarCal(numero, materia, double.Parse(txtCalificacion.Text));
                txtNumeroCal.Clear();
                txtMateria.Clear();
                txtCalificacion.Clear();
                txtNumeroCal.Focus();
        ...
        private void btnEliminarCal_Click(object sender, EventArgs e)
        {
            ...
            {
                int numero = int.Parse(txtNumero.Text);
                miLista.EliminarCalificacion(numero);
                txtNumeroCal.Clear();
                txtMateria.Clear();
                txtCalificacion.Clear();
                txtNumeroCal.Focus();
        ...
        private void lstvAlumnos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            miLista.MostrarMaterias(lstvCalificacion, numeroAlumno);
        }
